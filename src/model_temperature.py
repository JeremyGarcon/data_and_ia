...
def analyser_temperature_par_jour(fichier_csv, colonne_date="Date", colonne_temp="Temperature",
    ...
    if afficher_graphique:
        ...
        stats_par_jour["mean"].plot(label="Moyenne", marker="o", linestyle="-")
...
analyser_temperature_par_jour("/home/garcon/Documents/github/data_and_ia/src/data/donne_meteorologique.csv", date_fin="2022-08-03T17", date_debut="2022-01-11T13", afficher_graphique=True, Kelvin=False)
